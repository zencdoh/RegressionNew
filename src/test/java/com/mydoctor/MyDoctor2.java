...
public class MyDoctor2 {
	...
	public void verify_user_able_to_click_deleteDoctor_Link() throws InterruptedException{
		...
		driver.findElement(By.xpath("//*[@id='navlist']/li[3]/a")).click();
		System.out.println("click on DeleteDoctor link");
		Thread.sleep(1500);
		String s1=driver.findElement(By.xpath("//div[@id='contentcolumn']/h2")).getText();
		Assert.assertEquals(s1, "Delete Doc");
		Thread.sleep(1500);
		System.out.println("after clicking on Delete Doctor link verify text Delete Doc");
